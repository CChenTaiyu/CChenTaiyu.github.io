...
# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[LBX Blog](https://roselifetotj.github.io/)搭建出来了。。。
...
这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`RoseLifetoTJ.github.io`
...
keyword: "LBX, LBX Blog, 柏荧的博客, qiubaiying, 邱柏荧, iOS, Apple, iPhone" #关键词
...
搭建好博客之后 你可能不想直接使用 [RoseLifetoTJ.github.io](https://RoseLifetoTJ.github.io) 这么长的博客域名吧, 想换成想 [RoseLifetoTJ.top](http://RoseLifetoTJ.top) 这样简短的域名。那我们开始吧！
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `RoseLifetoTJ.top` 的域名第一年才只要4元~
